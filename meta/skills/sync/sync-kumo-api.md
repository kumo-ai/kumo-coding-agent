...
Update kumo-agent docs when a new version of the `kumoapi` package is released.
...
**This is the critical step.** Search the ENTIRE kumo-agent tree for
...
git commit -m "sync kumo-agent from kumo-api v<target_version>
